...
Partial Class FormCheckIn
    ...
    Private Sub InitializeComponent()
        ...
        txtNama.Location = New Point(130, 52)
        ...
        dtpTanggal.Location = New Point(130, 172)
        ...
        btnSimpan.Location = New Point(130, 240)
        ...
        cmbKamar.Location = New Point(130, 112)
        ...
        btnHapus.Location = New Point(295, 240)
        ...
        DataGridViewCellStyle4.BackColor = Color.FromArgb(CByte(15), CByte(23), CByte(42))
        DataGridViewCellStyle4.Font = New Font("Segoe UI", 10.5F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        DataGridViewCellStyle4.ForeColor = Color.White
        DataGridViewCellStyle4.SelectionBackColor = Color.FromArgb(CByte(59), CByte(130), CByte(246))
        DataGridViewCellStyle4.SelectionForeColor = SystemColors.HighlightText
        DataGridViewCellStyle4.WrapMode = DataGridViewTriState.True
        dgvCheckIn.ColumnHeadersDefaultCellStyle = DataGridViewCellStyle4
        ...
        DataGridViewCellStyle5.BackColor = Color.FromArgb(CByte(15), CByte(23), CByte(42))
        DataGridViewCellStyle5.Font = New Font("Segoe UI", 10.5F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        DataGridViewCellStyle5.ForeColor = Color.White
        DataGridViewCellStyle5.SelectionBackColor = Color.FromArgb(CByte(59), CByte(130), CByte(246))
        DataGridViewCellStyle5.SelectionForeColor = SystemColors.HighlightText
        DataGridViewCellStyle5.WrapMode = DataGridViewTriState.True
        dgvCheckIn.RowHeadersDefaultCellStyle = DataGridViewCellStyle5
        dgvCheckIn.RowHeadersWidth = 30
        DataGridViewCellStyle6.BackColor = Color.FromArgb(CByte(51), CByte(65), CByte(85))
        DataGridViewCellStyle6.ForeColor = Color.White
        DataGridViewCellStyle6.SelectionBackColor = Color.FromArgb(CByte(59), CByte(130), CByte(246))
        dgvCheckIn.RowsDefaultCellStyle = DataGridViewCellStyle6
